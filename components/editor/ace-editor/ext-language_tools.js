    ...
    (this.attach = function (e) {
      ...
      (this.removeRange = function (e) {
        ...
        e.tabstop.splice(t, 1),
          ...
          e.tabstop.length || ((t = this.tabstops.indexOf(e.tabstop)), t != -1 && this.tabstops.splice(t, 1), this.tabstops.length || this.detach());
      }),
        ...
        return (
          ...
          (n.setRow = function (e) {
            (e = Math.max(this.autoSelect ? 0 : -1, Math.min(this.data.length, e))),
              c.start.row != e && (n.selection.clearSelection(), (c.start.row = c.end.row = e || 0), n.session._emit("changeBackMarker"), n.moveCursorTo(e || 0, 0), n.isOpen && n._signal("select"));
          }),
          ...
          (n.show = function (e, t, r) {
            var s = this.container,
              ...
              c = l > o / 2 && !r;
            c && l + t + f > o
              ? ((a.$maxPixelHeight = l - 2 * this.$borderSize), (s.style.top = ""), (s.style.bottom = o - l + "px"), (n.isTopdown = !1))
              : ((l += t), (a.$maxPixelHeight = o - l - 0.2 * t), (s.style.top = l + "px"), (s.style.bottom = ""), (n.isTopdown = !0)),
              (s.style.display = "");
            var h = e.left;
            ...
            window.innerWidth - r.right < 320
              ? r.left < 320
                ? n.isTopdown
                  ...
                  : ((t.style.top = n.container.offsetTop - t.offsetHeight + "px"), (t.style.left = r.left + "px"), (t.style.right = ""), (t.style.bottom = ""))
  ...
  define("ace/autocomplete/text_completer", ["require", "exports", "module", "ace/range"], function (e, t, n) {
    ...
    t.getCompletions = function (e, t, n, r, i) {
      ...
      i(
        null,
        u.map(function (e) {
          // Commented next line to prevent "local" snippets from appearing in autocomplete menu
          //return { caption: e, value: e, score: s[e], meta: "local" };
        })
      );
    };
  }),
  define("ace/ext/language_tools", ["require", "exports", "module", "ace/snippets", "ace/autocomplete", "ace/config", "ace/lib/lang", "ace/autocomplete/util", "ace/autocomplete/text_completer", "ace/editor", "ace/config"], function (
    e,
    t,
    n
  ) {
